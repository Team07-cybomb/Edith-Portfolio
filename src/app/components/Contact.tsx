...
const socialLinks: SocialLink[] = [
  { icon: Linkedin, label: 'LinkedIn', href: '#', color: 'hover:text-[#8B5CF6] hover:border-[#8B5CF6]/50' },
  { icon: Twitter, label: 'Twitter', href: '#', color: 'hover:text-[#A855F7] hover:border-[#A855F7]/50' },
  { icon: Github, label: 'GitHub', href: '#', color: 'hover:text-[#8B5CF6] hover:border-[#8B5CF6]/50' },
  { icon: Mail, label: 'Email', href: 'mailto:manoj@example.com', color: 'hover:text-[#A855F7] hover:border-[#A855F7]/50' },
];
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full px-8 py-4 bg-gradient-to-r from-[#6366F1] to-[#A855F7] text-white rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-[#8B5CF6]/30 relative overflow-hidden group"
              >
                <motion.div
